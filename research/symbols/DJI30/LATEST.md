...
- Watchlist instrument: Dow Jones Industrial Average platform alias
- Asset class: Equity index
- Watchlist description: Price-weighted index of 30 large U.S. companies; resolve the exact index, future, fund, or CFD.
- Exact venue/product: Unresolved alias — No exact cash index, future month, fund, or broker CFD is specified.
...
Identity research used [DJI30 primary reference](https://www.spglobal.com/spdji/en/indices/equity/dow-jones-industrial-average/) and [a distinct official product/reference](https://www.cmegroup.com/education/lessons/e-mini-dow-product-overview) after fixing the shared cutoff. The price-weighted DJIA cash index differs from E-mini Dow futures, funds and broker CFDs; futures add a multiplier, quarterly expiry and margin path. The alias does not select an exact exposure. Because the exact exposure is unresolved, no product-specific price, news, curve, roll, settlement, delivery, margin, market response or catalyst conclusion is attached.
...
- Official source record(s): https://www.spglobal.com/spdji/en/indices/equity/dow-jones-industrial-average/; https://www.cmegroup.com/education/lessons/e-mini-dow-product-overview
