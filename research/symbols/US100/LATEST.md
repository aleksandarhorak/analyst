...
Identity research used [US100 primary reference](https://indexes.nasdaq.com/Index/Overview/NDX) and [a distinct official product/reference](https://www.cmegroup.com/markets/equities/nasdaq/nasdaq-futures.html) after fixing the shared cutoff. The Nasdaq-100 cash index and CME NQ, MNQ and other futures have different multipliers, maturity, fair-value and margin mechanics. The platform alias does not identify one of them or an ETF/CFD. Because the exact exposure is unresolved, no product-specific price, news, curve, roll, settlement, delivery, margin, market response or catalyst conclusion is attached.
...
- Official source record(s): https://indexes.nasdaq.com/Index/Overview/NDX; https://www.cmegroup.com/markets/equities/nasdaq/nasdaq-futures.html
