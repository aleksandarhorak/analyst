...
- Watchlist instrument: General Motors Company
- Asset class: Stock
- Watchlist description: Passenger and commercial vehicles, financing, electric vehicles, software, and mobility initiatives.
- Exact venue/product: General Motors Company — common_stock on XNYS; instrument `sec:cik:0001467858:GM`
...
Official-source search covered `2026-07-25T02:36:54Z` through `2026-08-01T02:36:54Z` and carried unresolved material items from `2026-06-02T02:36:54Z`. The newest useful public record was [GM Q2 2026 shareholder update](https://investor.gm.com/news-releases/news-release-details/q2-2026-letter-shareholders/), published 2026-07-21.

Reported fact: GM said it raised full-year guidance for a second time and reported an 8.6% North America EBIT-adjusted margin, up 2.5 points year over year. The linked full financial highlights were not completely reviewed.

Review boundary: Shareholder letter reviewed; earnings PDF and all financial highlights were not fully reviewed. Web access occurred after the decision cutoff and no archived response hash or authorized news packet was created, so point-in-time retrieval integrity is not independently proven. No prior-expectation, price/volume response, or priced-in conclusion is asserted.
...
- Official source record(s): https://investor.gm.com/news-releases/news-release-details/q2-2026-letter-shareholders/
