...
- Watchlist instrument: Alphabet Inc. Class C
- Asset class: Stock
- Watchlist description: Google search and advertising, YouTube, cloud computing, Android, and technology investments.
- Exact venue/product: Alphabet Inc. — class_c_capital_stock on XNAS; instrument `sec:cik:0001652044:GOOG`
...
Official-source search covered `2026-07-25T02:36:54Z` through `2026-08-01T02:36:54Z` and carried unresolved material items from `2026-06-02T02:36:54Z`. The newest useful public record was [Alphabet SEC issuer record](https://www.sec.gov/edgar/browse/?CIK=1652044), published searched through the cutoff.

Reported fact: No current operating release was established from the official-source retrieval. Potentially material financing records require exhibit-level identity and dilution reconciliation before use.

Review boundary: SEC issuer record searched; July official-source coverage was incomplete and no current catalyst document is relied upon. Web access occurred after the decision cutoff and no archived response hash or authorized news packet was created, so point-in-time retrieval integrity is not independently proven. No prior-expectation, price/volume response, or priced-in conclusion is asserted.
...
- Official source record(s): https://www.sec.gov/edgar/browse/?CIK=1652044
