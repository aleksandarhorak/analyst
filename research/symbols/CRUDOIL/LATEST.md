...
- Exact venue/product: Unresolved platform alias — Benchmark, grade, location, maturity, roll rule, and broker product are unspecified.
...
- Fundamental or supply/demand view: Insufficient evidence. Identity stop condition: Benchmark, grade, location, maturity, roll rule, and broker product are unspecified. Contract, venue, currency/unit, settlement, roll, margin, and liquidation terms remain unknown where applicable.
