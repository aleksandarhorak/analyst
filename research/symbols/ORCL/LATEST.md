...
- Watchlist instrument: Oracle Corporation
- Asset class: Stock
- Watchlist description: Database software, enterprise applications, and cloud infrastructure and services.
- Exact venue/product: Oracle Corporation — common_stock on XNYS; instrument `sec:cik:0001341439:ORCL`
...
Official-source search covered `2026-07-25T02:36:54Z` through `2026-08-01T02:36:54Z` and carried unresolved material items from `2026-06-02T02:36:54Z`. The newest useful public record was [Oracle fiscal 2026 Q4 and full-year results](https://investor.oracle.com/investor-news/news-details/2026/Oracle-Announces-Record-Q4-and-FY-2026-Results-Driven-by-Cloud-Infrastructure--Cloud-Applications/), published 2026-06-10.

Reported fact: Oracle reported $19.184 billion Q4 revenue, $67.4 billion fiscal-year revenue, $32.0 billion operating cash flow, negative $23.7 billion fiscal-year free cash flow and $638 billion remaining performance obligations; conversion, financing and capex risks remain material.

Review boundary: Release, main tables, non-GAAP notes and cautions reviewed; contract conversion and financing details were not fully reconciled. Web access occurred after the decision cutoff and no archived response hash or authorized news packet was created, so point-in-time retrieval integrity is not independently proven. No prior-expectation, price/volume response, or priced-in conclusion is asserted.
...
- Official source record(s): https://investor.oracle.com/investor-news/news-details/2026/Oracle-Announces-Record-Q4-and-FY-2026-Results-Driven-by-Cloud-Infrastructure--Cloud-Applications/
