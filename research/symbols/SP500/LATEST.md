...
Identity research used [SP500 primary reference](https://www.spglobal.com/spdji/en/indices/equity/sp-500/) and [a distinct official product/reference](https://www.cmegroup.com/trading/equity-index/eminifaq.html) after fixing the shared cutoff. The S&P 500 cash index, price/total-return variants, E-mini/Micro futures, ETFs and CFDs are distinct exposures. The alias supplies no product, maturity, multiplier or broker specification. Because the exact exposure is unresolved, no product-specific price, news, curve, roll, settlement, delivery, margin, market response or catalyst conclusion is attached.
...
- Official source record(s): https://www.spglobal.com/spdji/en/indices/equity/sp-500/; https://www.cmegroup.com/trading/equity-index/eminifaq.html
