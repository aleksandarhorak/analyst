...
- Watchlist instrument: Amazon.com, Inc.
- Asset class: Stock
- Watchlist description: E-commerce, Amazon Web Services cloud computing, logistics, and advertising.
- Exact venue/product: Amazon.com, Inc. — common_stock on XNAS; instrument `sec:cik:0001018724:AMZN`
...
Official-source search covered `2026-07-25T02:36:54Z` through `2026-08-01T02:36:54Z` and carried unresolved material items from `2026-06-02T02:36:54Z`. The newest useful public record was [Amazon Q2 2026 results](https://ir.aboutamazon.com/news-release/news-release-details/2026/Amazon-com-Announces-Second-Quarter-Results/default.aspx), published 2026-07-30 (exact release time not stated).

Reported fact: Amazon reported $200.6 billion sales, including $42.2 billion at AWS, and $27.5 billion operating income. Reported net income included $53.4 billion of non-operating pre-tax income mainly tied to Anthropic investments, while trailing-twelve-month free cash flow was negative after higher property and equipment purchases.

Review boundary: Release narrative, guidance and principal tables reviewed; supplemental lines and the subsequent Form 10-Q were not exhaustively reviewed. Web access occurred after the decision cutoff and no archived response hash or authorized news packet was created, so point-in-time retrieval integrity is not independently proven. No prior-expectation, price/volume response, or priced-in conclusion is asserted.
...
- Official source record(s): https://ir.aboutamazon.com/news-release/news-release-details/2026/Amazon-com-Announces-Second-Quarter-Results/default.aspx
