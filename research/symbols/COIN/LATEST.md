...
- Watchlist instrument: Coinbase Global, Inc.
- Asset class: Stock
- Watchlist description: Cryptocurrency trading, custody, staking, subscriptions, and digital-asset infrastructure.
- Exact venue/product: Coinbase Global, Inc. — class_a_common_stock on XNAS; instrument `sec:cik:0001679788:COIN`
...
Official-source search covered `2026-07-25T02:36:54Z` through `2026-08-01T02:36:54Z` and carried unresolved material items from `2026-06-02T02:36:54Z`. The newest useful public record was [Coinbase Q2 2026 earnings event](https://investor.coinbase.com/events-and-presentations/events/default.aspx), published 2026-07-30 after market close.

Reported fact: The official investor page establishes the Q2 earnings event, but the shareholder letter and Form 10-Q were not retrievable through the official dynamic pages in this run; cached company-highlight values were inconsistent and rejected.

Review boundary: Event metadata reviewed; decisive financial documents were inaccessible. Web access occurred after the decision cutoff and no archived response hash or authorized news packet was created, so point-in-time retrieval integrity is not independently proven. No prior-expectation, price/volume response, or priced-in conclusion is asserted.

Catalyst conclusion: **official event metadata; decisive document unavailable / insufficient evidence for direction**.
...
- Official source record(s): https://investor.coinbase.com/events-and-presentations/events/default.aspx
