...
- Watchlist instrument: Apple Inc.
- Asset class: Stock
- Watchlist description: Consumer devices, services, and the Apple hardware/software ecosystem.
- Exact venue/product: Apple Inc. — common_stock on XNAS; instrument `sec:cik:0000320193:AAPL`
...
Official-source search covered `2026-07-25T02:36:54Z` through `2026-08-01T02:36:54Z` and carried unresolved material items from `2026-06-02T02:36:54Z`. The newest useful public record was [Apple fiscal Q3 2026 results](https://www.apple.com/newsroom/2026/07/apple-reports-third-quarter-results/), published 2026-07-30 (exact release time not stated).

Reported fact: Apple reported quarterly revenue of $109.4 billion, up 16% year over year, 50.1% gross margin and $2.02 diluted EPS; tariff refunds contributed about two gross-margin points and $0.11 of EPS, limiting clean comparability.

Review boundary: Issuer release reviewed in full; consolidated PDF and Form 10-Q were not fully reviewed. Web access occurred after the decision cutoff and no archived response hash or authorized news packet was created, so point-in-time retrieval integrity is not independently proven. No prior-expectation, price/volume response, or priced-in conclusion is asserted.
...
- Official source record(s): https://www.apple.com/newsroom/2026/07/apple-reports-third-quarter-results/
