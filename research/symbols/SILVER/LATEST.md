...
Identity research used [SILVER primary reference](https://www.lbma.org.uk/prices-and-data/lbma-silver-price) and [a distinct official product/reference](https://www.cmegroup.com/markets/metals/precious/silver.contractSpecs.html) after fixing the shared cutoff. London silver benchmark exposure and COMEX futures are not interchangeable; units, licensing, delivery, maturity, margin and roll treatment differ. The alias does not select an exact product. Because the exact exposure is unresolved, no product-specific price, news, curve, roll, settlement, delivery, margin, market response or catalyst conclusion is attached.
...
- Official source record(s): https://www.lbma.org.uk/prices-and-data/lbma-silver-price; https://www.cmegroup.com/markets/metals/precious/silver.contractSpecs.html
