...
- Watchlist instrument: Strategy Inc
- Asset class: Stock
- Watchlist description: Bitcoin-treasury exposure combined with enterprise analytics software and capital-markets activity.
- Exact venue/product: Strategy Inc — class_a_common_stock on XNAS; instrument `sec:cik:0001050446:MSTR`
...
Official-source search covered `2026-07-25T02:36:54Z` through `2026-08-01T02:36:54Z` and carried unresolved material items from `2026-06-02T02:36:54Z`. The newest useful public record was [Strategy Q2 2026 results](https://www.strategy.com/press/strategy-announces-second-quarter-2026-financial-results_07-30-2026), published 2026-07-30.

Reported fact: Strategy reported a large operating and net loss dominated by unrealized digital-asset losses, $122.4 million revenue and more than 843,000 BTC. Its release contains differing exact and rounded holdings figures, so holdings, senior claims and dilution need full reconciliation.

Review boundary: Issuer release reviewed; Form 10-Q and calculation exhibits were not fully reviewed. Web access occurred after the decision cutoff and no archived response hash or authorized news packet was created, so point-in-time retrieval integrity is not independently proven. No prior-expectation, price/volume response, or priced-in conclusion is asserted.
...
- Official source record(s): https://www.strategy.com/press/strategy-announces-second-quarter-2026-financial-results_07-30-2026
