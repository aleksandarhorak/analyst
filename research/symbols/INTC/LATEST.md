...
- Watchlist instrument: Intel Corporation
- Asset class: Stock
- Watchlist description: CPUs, data-center products, semiconductor manufacturing, and foundry services.
- Exact venue/product: Intel Corporation — common_stock on XNAS; instrument `sec:cik:0000050863:INTC`
...
Official-source search covered `2026-07-25T02:36:54Z` through `2026-08-01T02:36:54Z` and carried unresolved material items from `2026-06-02T02:36:54Z`. The newest useful public record was [Intel Q2 2026 results](https://www.intc.com/news-events/press-releases/detail/1776/intel-reports-second-quarter-2026-financial-results), published 2026-07-23.

Reported fact: Intel reported $16.1 billion revenue and a large GAAP loss while presenting positive non-GAAP income and Q3 revenue guidance of $15.8-16.8 billion. The GAAP/non-GAAP divergence and Altera deconsolidation require fuller reconciliation.

Review boundary: Issuer release and key reconciliations reviewed; the complete Form 10-Q and presentation were not exhaustively reviewed. Web access occurred after the decision cutoff and no archived response hash or authorized news packet was created, so point-in-time retrieval integrity is not independently proven. No prior-expectation, price/volume response, or priced-in conclusion is asserted.
...
- Official source record(s): https://www.intc.com/news-events/press-releases/detail/1776/intel-reports-second-quarter-2026-financial-results
