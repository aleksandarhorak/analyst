...
- Watchlist instrument: Advanced Micro Devices, Inc.
- Asset class: Stock
- Watchlist description: CPUs, GPUs, data-center accelerators, embedded processors, and semiconductor design.
- Exact venue/product: Advanced Micro Devices, Inc. — common_stock on XNAS; instrument `sec:cik:0000002488:AMD`
...
Official-source search covered `2026-07-25T02:36:54Z` through `2026-08-01T02:36:54Z` and carried unresolved material items from `2026-06-02T02:36:54Z`. The newest useful public record was [AMD-Anthropic strategic partnership](https://ir.amd.com/news-events/press-releases/detail/1292/amd-and-anthropic-announce-strategic-partnership-to-deploy-up-to-2-gigawatts-of-amd-instinct-mi450-series-gpus), published 2026-07-22.

Reported fact: The companies announced planned deployment of up to two gigawatts of MI450-series GPUs, with the first gigawatt beginning in the first half of 2027, and a future AMD strategic equity investment of up to $5 billion. Deployment, timing and economics remain contingent and partly undisclosed.

Review boundary: Issuer release reviewed in full; contract economics and revenue timing were not available. Web access occurred after the decision cutoff and no archived response hash or authorized news packet was created, so point-in-time retrieval integrity is not independently proven. No prior-expectation, price/volume response, or priced-in conclusion is asserted.
...
- Official source record(s): https://ir.amd.com/news-events/press-releases/detail/1292/amd-and-anthropic-announce-strategic-partnership-to-deploy-up-to-2-gigawatts-of-amd-instinct-mi450-series-gpus
