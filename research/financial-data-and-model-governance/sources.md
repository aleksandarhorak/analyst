...
| [SEC company tickers and exchanges](https://www.sec.gov/files/company_tickers_exchange.json) | Checked 2026-08-01 | Current CIK, issuer name, ticker, and exchange fields seed the versioned registry for the active U.S.-listed securities. | Does not resolve broker aliases, contract months, cash indexes, funds, CFDs, currency, or price/news entitlements; SEC warns the file is not guaranteed for accuracy or scope. | High for SEC identity fields, conditional on runtime reconciliation |
...
| [CFTC Disaggregated Futures Only dataset](https://publicreporting.cftc.gov/Commitments-of-Traders/Disaggregated-Futures-Only/72hh-3qpy) | Dataset `72hh-3qpy`, checked at cutoff | Official dataset catalogue and field metadata used by the default CFTC adapter. | Dataset/version and fields must be checked at runtime; callers still select the exact contract-market code. | High |
